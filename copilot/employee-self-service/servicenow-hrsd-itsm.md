...
:::image type="content" source="media/agent-servicenow-integration.png" alt-text="Diagram that shows the high-level components comprising overall solution for ESS agent and ServiceNow HRSD integration." lightbox="media/agent-servicenow-integration.png":::
...
8. Fill in the following information for the new application registry:
    ...
    | **Client ID** | autogenerated code <br><div class="alert">**Note**</br>This value is used in Microsoft Graph Connector configuration, if no Advanced Scripting is used. |
    | **Client Secret** | leave it blank to automatically generate a string <br><div class="alert">**Note**</br>This value is used in Microsoft Graph Connector configuration, if no Advanced Scripting is used. |
...
:::image type="content" source="media/media/service-now-topics.png" alt-text="Diagram that shows the ServiceNow ITSM topics.":::
...
- [ServiceNow Catalog Microsoft Graph connector | Microsoft Learn](/microsoftsearch/servicenow-catalog-connector#3-authentication-type)
