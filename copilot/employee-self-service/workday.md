...
[![Infographic that describes the components of the ESS agent and Workday integration.](workday-1.png)](workday-1.png#lightbox)
...
1. [Create reports](#ctask-7-reate-reports)
...
![Screenshot of the page where you configure the redirection URL](workday-2.png)
...
1. Configure SAML Identity Provider. Verify the following fields if SSO is already configured for Workday with Entra:
|Field |Description |
|------|------------|
...
[![Screenshot of the Scope(Functional areas)](workday-3.png)](workday-3.png#lightbox)
...
![Screenshot showing where to add policies.](workday-4.png)

![Screenshot showing where to put Domain Security Policies permitting Get access.](workday-5.png)
...
![Screenshot of the flow to add a Topic redirect](workday-6.png)
