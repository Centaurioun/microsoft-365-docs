...
|The agent doesn't yet support many languages—English is currently supported. |Support for multiple languages is planned for release by the end of 2025. |Begin with English-speaking users and regions—additional language support is on the way. |
