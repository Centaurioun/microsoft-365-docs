...
Retrieves specific link:investigation.md[Investigation] by its ID. ID
can be the investigation ID or the investigation triggering alert ID.
...
link:investigation.md[Investigations] entity.
