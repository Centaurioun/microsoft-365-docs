...
If successful and IP exists - 200 OK with list of link:alerts.md[alert]
entities in the body. If IP address is unknown but valid, it will return
an empty set. If the IP address is invalid, it will return HTTP 400.
