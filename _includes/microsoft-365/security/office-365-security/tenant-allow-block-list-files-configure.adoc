...
link:submissions-admin.md#report-questionable-email-attachments-to-microsoft[Report
...
For instructions, see
link:submissions-admin.md#report-good-email-attachments-to-microsoft[Report
