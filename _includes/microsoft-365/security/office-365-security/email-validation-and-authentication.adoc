...
* link:set-up-spf-in-office-365-to-help-prevent-spoofing.md[SPF]
* link:use-dkim-to-validate-outbound-email.md[DKIM]
...
link:anti-spam-message-headers.md#authentication-results-message-header[Authentication-results
message header].
...
* link:set-up-spf-in-office-365-to-help-prevent-spoofing.md[Configure
SPF records] for your domains.
* link:use-dkim-to-validate-outbound-email.md[Configure DKIM records]
for your primary domains.
* link:use-dmarc-to-validate-email.md[Consider setting up DMARC records]
for your domain to determine your legitimate senders.
...
You can also use the link:learn-about-spoof-intelligence.md[spoof
intelligence insight] and the
link:manage-tenant-allow-block-list.md[Tenant Allow/Block List] to
permit senders to transmit unauthenticated messages to your
organization.
...
* link:how-office-365-uses-spf-to-prevent-spoofing.md[More about SPF]
* link:support-for-validation-of-dkim-signed-messages.md[More about
DKIM]
