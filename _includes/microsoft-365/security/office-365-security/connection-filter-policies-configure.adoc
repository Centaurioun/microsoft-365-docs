...
overall anti-spam settings, see
...
added to the message’s link:message-headers-eop-mdo.md[anti-spam message
headers] (indicating the message bypassed spam filtering), but the
message is still subject to spam filtering.
