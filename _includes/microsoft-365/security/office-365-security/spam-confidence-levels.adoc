...
|9 |Spam filtering marked the message as *High confidence spam* |Deliver
the message to the recipients’ Junk Email folder.
|===
...
link:configure-your-spam-filter-policies.md[Configure anti-spam policies
in EOP], link:bulk-complaint-level-values.md[Bulk complaint level (BCL)
in EOP)], and
