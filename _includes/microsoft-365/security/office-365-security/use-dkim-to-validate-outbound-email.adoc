...
* link:use-dkim-to-validate-outbound-email.md#Publish2CNAME[Publish two
CNAME records for your custom domain in DNS]
* link:use-dkim-to-validate-outbound-email.md#EnableDKIMinO365[Enable
...
in link:use-dkim-to-validate-outbound-email.md#SetUpDKIMO365[What you
...
see link:set-up-spf-in-office-365-to-help-prevent-spoofing.md[*Set up
SPF in Microsoft 365 to help prevent spoofing*]. For a more in-depth
understanding of how Microsoft 365 uses SPF, or for troubleshooting or
...
Next, see link:use-dmarc-to-validate-email.md[*Use DMARC to validate
email*]. link:anti-spam-message-headers.md[Anti-spam message headers]
includes the syntax and header fields used by Microsoft 365 for DKIM
checks.
...
link:/microsoft-365/security/office-365-security/use-dmarc-to-validate-email[Use
