...
described in link:view-email-security-reports.md[View email security
...
*link:view-email-security-reports.md#export-report[Export]* button is
available.
...
link:safe-links.md[Safe Links]. This report will not have click data
from users where the Safe Links policy was applied when the *Track user
clicks* option is not selected.
...
*link:view-email-security-reports.md#schedule-report[Create schedule]*,
image:../../media/m365-cc-sc-download-icon.png[Request report icon.]
*link:view-email-security-reports.md#request-report[Request report]*,
and image:../../media/m365-cc-sc-download-icon.png[Export icon.]
*link:view-email-security-reports.md#export-report[Export]* buttons are
available.
...
must have link:set-up-safe-links-policies.md[Safe Links policies] and
link:set-up-safe-attachments-policies.md[Safe Attachments policies]
defined in order for Defender for Office 365 protection to be in place.
Also see link:anti-spam-protection.md[anti-spam] and
