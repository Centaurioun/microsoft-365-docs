...
+
____
[!NOTE] You can’t use dynamic distribution groups to target users.
____
** *Search for users or groups*: In box, you can type part of the *Name*
or *Email address* of the user or group and then press Enter. You can
select some or all of the results. When you’re finished, click *Add x
users*.
+
____
...
**** *Search*: In image:../../media/m365-cc-sc-search-icon.png[Search by
user tags icon.] *Search by user tags*, you can type part of the user
...
**** *Search*: In image:../../media/m365-cc-sc-search-icon.png[Search by
Department icon.] *Search by Department*, you can type part the
...
**** *Search*: In image:../../media/m365-cc-sc-search-icon.png[Search by
Title icon.] *Search by Title*, you can type part of the Title value and
...
region.
* *Display the drive-by technique interstitial data gathered page*: You
can show the overlay that appears for the drive-by URL technique
attacks. To hide this overlay and directly go to the landing page,
