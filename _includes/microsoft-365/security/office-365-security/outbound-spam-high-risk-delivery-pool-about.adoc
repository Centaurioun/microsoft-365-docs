...
spam and link:anti-spam-backscatter-about.md[backscatter]. Using the
...
For more information, see link:outbound-spam-protection-about.md[Control
outbound spam].
...
* link:outbound-spam-policies-configure.md[Outbound spam policies] where
the senders are restricted from sending mail.
____
...
_link:anti-spam-backscatter-about.md[backscatter]_).
...
read on how to enable at link:email-authentication-dkim-configure.md[Use
