...
Office 365] provides an additional layer of protection for files that
have already been scanned asynchronously by the
link:virus-detection-in-spo.md[common virus detection engine in
Microsoft 365]. Safe Attachments for SharePoint, OneDrive, and Microsoft
Teams helps detect and block existing files that are identified as
malicious in team sites and document libraries.
...
link:view-reports-for-mdo.md[reports for Microsoft Defender for Office
365] and in link:threat-explorer.md[Explorer (and real-time
detections)].
...
link:manage-quarantined-messages-and-files.md#use-the-microsoft-365-defender-portal-to-manage-quarantined-files-in-defender-for-office-365[Manage
