...
see link:reports-defender-for-office-365.md[View Defender for Office 365
...
|link:reports-defender-for-office-365.md#url-protection-report[URL
protection report]
...
link:reports-email-security.md#spam-detections-report[Spam Detections
report].
...
link:reports-defender-for-office-365.md#mail-latency-report[Mail latency
report].
...
see link:anti-phishing-protection-spoofing-about.md[Anti-spoofing
protection in EOP].

The aggregate and detail views of the report allows for 90 days of
filtering.
...
link:submissions-admin.md[admin submissions in the Microsoft 365
Defender portal], click *Go to Submissions*. Admins will be able to view
the report for last 30 days.
...
information, see
link:submissions-admin.md#view-email-admin-submissions-to-microsoft[View
...
link:safe-links-about.md[Safe Links],
link:safe-attachments-about.md[Safe Attachments], and
link:anti-phishing-policies-about.md#exclusive-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365[impersonation
...
* *Tag*: *All* or the specified user tag (including priority accounts).
For more information about user tags, see link:user-tags-about.md[User
tags].
* *Direction*:
** *All*
** *Inbound*
...
* *File detonation**: link:safe-attachments-about.md[Safe Attachments]
...
link:safe-attachments-about.md[Safe Attachments] detonations in other
...
link:anti-phishing-policies-about.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365[anti-phishing
policies].
...
link:email-authentication-dmarc-configure.md[DMARC authentication].
...
* *URL detonation**: link:safe-links-about.md[Safe Links] detected a
malicious URL in the message during detonation analysis.
* *URL detonation reputation**: URLs previously detected by
link:safe-links-about.md[Safe Links] detonations in other Microsoft 365
organizations.
...
* *Advanced filter*: Phishing signals based on machine learning.
* *Bulk*: The link:anti-spam-bulk-complaint-level-bcl-about.md[bulk
complaint level (BCL)] of the message exceeds the defined threshold for
spam.
...
(link:anti-malware-protection-about.md[common attachment filtering in
...
link:anti-malware-protection-for-spo-odfb-teams-about.md[built-in virus
detection in Microsoft 365].
...
detected by link:anti-malware-protection-about.md[anti-malware
protection in EOP].
...
detected by link:safe-attachments-about.md[Safe Attachments] or phishing
detected by
...
link:submissions-admin.md[admin submissions in the Microsoft 365
Defender portal], click *Go to Submissions*.
...
link:/exchange/monitoring/mail-flow-reports/mail-flow-reports[View mail
