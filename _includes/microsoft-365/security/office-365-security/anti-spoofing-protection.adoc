...
link:email-validation-and-authentication.md[Email authentication in
Microsoft 365].
+
...
information, see
link:set-up-anti-phishing-policies.md#exclusive-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365[Exclusive
...
related to spoofing, see link:anti-spam-message-headers.md[_Anti-spam
message headers in Microsoft 365_]. Or go directly to the
link:anti-spam-message-headers.md[_reason_] codes.
____
...
in link:learn-about-spoof-intelligence.md[Spoof intelligence insight in
EOP] and link:manage-tenant-allow-block-list.md[Manage the Tenant
Allow/Block List].
...
link:allow-block-email-spoof.md#create-allow-entries-for-spoofed-senders[Create
...
link:email-validation-and-authentication.md#solutions-for-legitimate-senders-who-are-sending-unauthenticated-email[Solutions
