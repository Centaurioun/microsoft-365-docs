= International banking account number (IBAN) entity definition
:audience: Admin
:author: chrfox
...
The format for each country is slightly different.
The IBAN sensitive information type covers these 68 countries:
