...
| Probability status           | The likelihood that the prediction is correct. Probability values include High, Medium, or Low. |
...
| Trend                        | Monthly active usage over the previous three months: No change, Positive, or Negative. |
