...
- **Mid-term changes**: If the customer adds seats on **June 15th**, the prorated charge appears on an invoice with a different cadence around July 5th. These prorated changes do **not** appear on recurring charges invoices, but the recurring invoices will show the new seat total.
...
- **Mid-term changes**: If seats are added on **December 10, 2025**, the prorated charge appears on an invoice with a different cadence around January 5th. At renewal, the new seat total will be billed for the upcoming term.
