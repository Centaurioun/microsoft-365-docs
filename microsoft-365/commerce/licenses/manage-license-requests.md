...
6. To assign licenses based on group membership, select **Assign license by adding people to the following security group**.
   ...
   - For more information about how to assign licenses to a security group, see [Assign or unassign licenses to a group using the Microsoft 365 admin center](../../admin/manage/manage-group-licenses)
