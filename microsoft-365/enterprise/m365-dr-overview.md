...
| Term | Definition |
|:-----|:-----|
|Macro Region Geography |Macro Region Geography 1 – Europe, Macro Region Geography 2 – Asia Pacific, Macro Region Geography 3 - North America, Macro Region Geography 4 - EU/EFTA |
...
|Macro Region Geography 3 - North America |Data centers in Canada, Mexico, and the United States |
...
|Macro Region Geography 4 - European Union/EFTA |Data centers in in Austria, Finland, France, Germany, Ireland, Italy, Netherlands, Poland, Spain, Sweden, Norway, and Switzerland. <br/> <br/> **Note:** Note: This term is referenced as “European Union/EFTA” on the Data Location Card. |
...
|European Union (EU) |An international organization comprising 27 European countries. These countries are **Austria**, Belgium, Bulgaria, Croatia, Cyprus, Czechia, Denmark, Estonia, **Finland**, **France**, **Germany**, Greece, Hungary, **Ireland**, **Italy**, Latvia, Lithuania, Luxembourg, Malta, **Netherlands**, **Poland**, Portugal, Romania, Slovakia, Slovenia, **Spain**, and **Sweden**. <br/> <br/> **Note:** Note: Microsoft 365 currently has datacenters in the **bold** EU countries. |
|European Free Trade Association (EFTA) |A regional trade organization and free trade area consisting of four European states - Liechtenstein, Iceland, Norway, and Switzerland. <br/> <br/> **Note:** Note: Microsoft 365 currently has datacenters in the **bold** EFTA countries. |
...
|Current Geography |Current Geography refers to the location where M365 core & expanded workload (ADR scoped) data is stored for the service. Definitions of current Macro Region Geographies can be found [here](m365-dr-overview.md#table-1-definitions-and-terms). <br/> <br/> **Note:** Note: In certain scenarios, _Current Geography_ may differ from _Committed Geography_, such as during migration, due to ADR license validity, or at the time-of-service provisioning and activation relative to the availability of go-local. For detailed information on these cases, please visit NEW DLC PAGE LINK. |
