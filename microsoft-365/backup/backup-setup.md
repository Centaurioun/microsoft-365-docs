...
|[:::image type="content" source="../media/m365-backup/button1.png" alt-text="Clickable image that says Set up pay-as-you-go billing.":::](#step-2-set-up-pay-as-you-go-billing)     |[:::image type="content" source="../media/m365-backup/step1.png" alt-text="Clickable image that says Set up pay-as-you-go billing.":::](#step-2-set-up-pay-as-you-go-billing)         |
|[:::image type="content" source="../media/m365-backup/button1.png" alt-text="Clickable image that says Turn on Microsoft 365 Backup.":::](#step-3-turn-on-microsoft-365-backup)     |[:::image type="content" source="../media/m365-backup/backup-setup-step1" alt-text="Clickable image that says Turn on Microsoft 365 Backup.":::](#step-3-turn-on-microsoft-365-backup)         |
