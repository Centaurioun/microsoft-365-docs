...
> [!TIP]
> **Already have an Azure subscription and are a SharePoint Administrator / Global Administrator?** Follow these three steps to quickly set up Microsoft 365 Backup in the admin center.<br><br>
