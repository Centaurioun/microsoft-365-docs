...
> [!TIP]
> **Already have an Azure subscription and the [required admin role](#admin-roles-and-backup-management-privileges)?** Follow these three steps to set up Microsoft 365 Backup in the admin center.<br><br>
