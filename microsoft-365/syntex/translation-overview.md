...
| ![Compliance symbol.](/office/media/icons/compliance-blue.png)  | **Manage List permission** <br>A user must be a site member to create translated file copies, which requires the necessary Manage List permission. |
