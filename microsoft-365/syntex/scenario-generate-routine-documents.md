...
4. Now create a Power Automate flow using the action to generate document and use the trigger “When a list item is created.” This action ensures that whenever a new entry is added by a frontline worker to the list, a new report is generated.  
